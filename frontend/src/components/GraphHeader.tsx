...
const GraphHeader: React.FC<GraphHeaderProps> = ({ title, onRefresh, onDownload, onToggleFullscreen, isFullscreen }) => {
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" onClick={onRefresh} aria-label="Refresh Data">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" onClick={onDownload} aria-label="Download CSV">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="outline" onClick={onToggleFullscreen} aria-label={isFullscreen ? "Exit Fullscreen" : "Enter Fullscreen"}>
