        ...
        <div className="flex items-center mx-auto">
          <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <span className="[&_p]:inline">
              This deployed version is using free services, so the limit for
              data being fetched is 1 month. To use, input your Breeze API key
              and secret in the account section, then follow the instructions to
