...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="container max-w-4xl mx-auto space-y-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="text-muted-foreground">C, C++, Java, Python, JavaScript/TypeScript</p>
              </div>
              <div>
                <h3 className="mb-2 font-semibold">Frameworks</h3>
                <p className="text-muted-foreground">Django, Fast API, Flask, Spring, Express, React, Next.js, Angular, Vue</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">Git, Docker, Docker Compose, GitHub Actions, AWS, GCP</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="mb-2 text-sm text-muted-foreground">RiskTec Systems, Toronto, ON | Apr 2024 - Present</p>
            ...
            <div>
              ...
              <p className="mb-2 text-sm text-muted-foreground">GenioBITS Technologies, Pune, MH | Jun 2022 - Mar 2023</p>
              <ul className="pl-5 space-y-1 list-disc text-muted-foreground">
