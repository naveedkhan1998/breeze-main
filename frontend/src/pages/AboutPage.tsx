          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                evaluation to implementation and debugging. I collaborate closely
                with fellow engineers to build robust applications, optimize
                performance, and enhance user engagement. I prioritize enhancing
                my communication and collaboration skills, recognizing their
              ...
              <div>
                ...
                <ul className="pl-5 space-y-1 list-disc text-muted-foreground">
                  <li>
                    ...
                    model, ensuring the application's database strictly adhered to
                    it.
                  </li>
                  <li>
                  ...
                  <li>
                    Led the implementation of a comprehensive and dynamic mandate
                    check logic for pre-trade tickets.
                  </li>
                </ul>
              </div>
              <Separator />
              <div>
                ...
                <ul className="pl-5 space-y-1 list-disc text-muted-foreground">
                  ...
                  <li>
                    ...
                    possible strategy combinations, and running backtests on them.
                  </li>
                  <li>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  building websites; we're crafting digital experiences that leave
                  a lasting impact.
                </p>
              </CardContent>
            </Card>
