    ...
    <div className="min-h-screen p-2 bg-gradient-to-b from-background to-muted sm:p-4">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-6xl mx-auto mt-4 sm:mt-8">
        <Card>
          ...
          <CardContent>
            <div className="sticky z-10 p-4 mb-4 rounded-lg shadow-md dark:shadow-slate-600 top-16 ">
              <div className="flex items-center gap-2">
                <div className="relative flex-grow">
                  <Search className="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground" />
                  <Input id="searchTerm" type="text" placeholder="Search instruments..." value={searchTerm} onChange={handleChange} className="pl-8" />
                </div>
              </div>
            </div>
