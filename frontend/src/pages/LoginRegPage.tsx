...
import { LockIcon, UserPlusIcon, LineChart, Shield, BarChart4, Clock, Smartphone } from "lucide-react";
...
const LoginRegPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-4 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 dark:from-gray-900 dark:via-purple-900 dark:to-violet-900">
            ...
            <div className="relative col-span-2 p-8 text-white bg-gradient-to-br from-indigo-600 to-purple-700">
              <div className="sticky space-y-8 top-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-indigo-100">Your gateway to intelligent trading</p>
                </div>
                ...
                <div className="space-y-6">
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="p-2 rounded-lg bg-white/10 backdrop-blur-lg">{feature.icon}</div>
                ...
                <div className="pt-4">
                  <div className="p-4 rounded-lg bg-white/10 backdrop-blur-lg">
                    <p className="text-sm text-indigo-100">"Experience the future of trading with our advanced platform"</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-3 p-8 max-h-[90vh] overflow-y-auto">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <TabsList className="sticky top-0 z-10 grid w-full grid-cols-2 bg-white dark:bg-gray-800">
                  ...
                  <TabsTrigger value="registration" className="data-[state=active]:bg-indigo-600 data-[state=active]:text-white">
                ...
                <motion.div className="relative">
                  ...
                  <TabsContent value="registration">
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} transition={{ duration: 0.3 }} className="mt-4">
                      <Registration />
                    </motion.div>
                  </TabsContent>
                </motion.div>
              ...
              <motion.div className="mt-6 text-center text-gray-500 dark:text-gray-400" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
                <p className="text-sm">
